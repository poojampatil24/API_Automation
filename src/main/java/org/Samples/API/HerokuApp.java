...
import static org.Samples.Listener.TestListener.test;
...
public class HerokuApp {
    ...
    public static Response authAPI(String resource,String id, String pass){
        try {
            ...
            BaseConfig.logger.info("User Authenticated successfully");
        ...
        try {
            Response response =
                    ...
                    then().
                            ...
                            statusCode(200).
                            extract().response();
            BaseConfig.logger.info("Fetched All Bookings");
        ...
        try {
            Response response =
                    ...
                    then().
                            ...
                            .extract().response();
            BaseConfig.logger.info("Details of booingId:" + bookingId + " is:");
            BaseConfig.logger.info(response.asString());
    ...
    public static Response addNewBooking(String resource, String jsonString){
       try {
          Response response =
                  ...
                  then().
                          assertThat().statusCode(200).extract().response();
           BaseConfig.logger.info("Booking added successfully");
...
//    }
    ...
    public static String getBookingId(Response response){
        try {
            ...
            BaseConfig.logger.info("Booking id is:" + id);
    ...
    public static String getBookingId_KeyValue(Response response,String bookingId,String key){
        try {
            ...
            BaseConfig.logger.info("" + key + " for " + bookingId + " is:" + keyValue);
    ...
    public static void verifyBooking(String bookingid,String key,String keyValue) {
        try {
            ...
            BaseConfig.logger.info("verified that "+key+" is as expected :"+keyValue);
